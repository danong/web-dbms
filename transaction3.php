     ...
     <div class="container-fluid">
      <div class="row">
	    ...
	    $ownername = $_POST['name'];
            if($conn){
                echo "<h4> Displaying properties for branch: $branchno and owner: $ownername</h4>";
                }
            else {
                $e = oci_error;
            ...
            $sql = "SELECT Rental_Property.rentalNo, Rental_Property.street, Rental_Property.city, Rental_Property.monthRent
                    FROM Rental_Property, Employee, Property_Owner
                    WHERE rental_property.status = 'available'
                        AND rental_property.supervisorID = Employee.empID
			AND Employee.branchNo = '$branchno'
			AND rental_property.propOwnerID = Property_Owner.propOwnerID
			AND Property_Owner.name = '$ownername'";
            ...
            echo "<TH>Rental ID</TH><TH>Street</TH><TH>City</TH><TH>Rent</TH>";
