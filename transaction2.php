     ...
     <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm9 col-sm-offset-3 col-md10 col-md-offset-2 main" id="maincon">
            ...
            if($conn){
                echo "<h4> Displaying properties for supervisors: </h4>";
                }
            else {
                $e = oci_error;
            ...
            $sql = "SELECT Employee.empID, Employee.name, Rental_Property.rentalNo, Rental_Property.street, Rental_Property.city, Rental_Property.monthRent
                    FROM Rental_Property, Employee
                    WHERE rental_property.supervisorID = Employee.empID
            ...
            echo "<TR><TH>Supervisor ID</TH><TH>Supervisor Name</TH><TH>Rental Number</TH><TH>Street</TH><TH>City</TH><TH>Rent</TH>";
