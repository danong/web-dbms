     ...
     <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm9 col-sm-offset-3 col-md10 col-md-offset-2 main" id="maincon">
            <h1 class="page-header">Leases Ending Soon</h1>
            <?php
            $conn=oci_connect('dong','dan0ng01', '//dbserver.engr.scu.edu/db11g');
            if($conn){
                echo "<h4> Displaying the names and addresses of properties whose leases will expire in the next two months</h4>";
                }
            else {
                $e = oci_error;
            ...
            $sql = "SELECT rentalNo, enddate, street, city, zip
		    FROM Lease_Agreement natural join Rental_Property
		    WHERE MONTHS_BETWEEN(endDate, SYSDATE) <= 2
		    AND MONTHS_BETWEEN(endDate, SYSDATE) >= 0";
            ...
            echo "<TH>Rental ID</TH><TH>End Date</TH><TH>Street</TH><TH>City</TH><TH>Zip</TH>";
