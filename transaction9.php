     ...
     <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm9 col-sm-offset-3 col-md10 col-md-offset-2 main" id="maincon">
            <h1 class="page-header">Show Number of Properties Available By Branch</h1>
            <?php
            $conn=oci_connect('dong','dan0ng01', '//dbserver.engr.scu.edu/db11g');
            if($conn){
                echo "<h4>Showing the number available properties per branch</h4>";
                }
            else {
                $e = oci_error;
            ...
            echo "<TH>Branch</TH><TH>Number of Available Properties</TH>";
