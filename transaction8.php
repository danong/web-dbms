     ...
     <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm9 col-sm-offset-3 col-md10 col-md-offset-2 main" id="maincon">
            <h1 class="page-header">Renters with Multiple Properties</h1>
            <?php
            $conn=oci_connect('dong','dan0ng01', '//dbserver.engr.scu.edu/db11g');
            if($conn){
                echo "<h4> Displaying renters who rented more than one rental property</h4>";
                }
            else {
                $e = oci_error;
            ...
            $sql = "SELECT renterID, name
		    FROM Renter
		    WHERE renterID IN(
		    SELECT renterID
		    FROM Lease_Agreement
		    GROUP BY renterID
		    HAVING count(rentalNo) >= 2)";
            ...
            echo "<TH>Rental ID</TH><TH>Name</TH>";
